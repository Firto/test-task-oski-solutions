...
namespace OSKI_SOLUTIONS.DataAccess.Migrations
{
    ...
    [Migration("20211110123018_initial")]
            ...
            modelBuilder.Entity("OSKI_SOLUTIONS.DataAccess.Entities.Tests.QuestionOfTest", b =>
                {
                    ...
                    b.Property<int>("maxQuestionsCount")
                        .HasColumnType("integer");

                    b.Property<int>("maxSelectedQuestionsCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("OSKI_SOLUTIONS.DataAccess.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "admin",
                            Login = "admin",
                            PasswordHash = "B166ADZL6OMJRZN1759B1BC0DB74110C63A1EC22C940E1002705F51A7C1062908AFA2353DEA4E16E5FF90A982477C9EEBAE620DB40"
                        });
                });
            ...
            modelBuilder.Entity("OSKI_SOLUTIONS.DataAccess.Entities.Tests.Session.OptionOfQuestionInSession", b =>
                {
                    ...
                    b.HasOne("OSKI_SOLUTIONS.DataAccess.Entities.Tests.Session.QuestionOfSession", null)
                        .WithMany("Options")
            ...
            modelBuilder.Entity("OSKI_SOLUTIONS.DataAccess.Entities.Tests.Session.QuestionOfSession", b =>
                {
                    ...
                    b.HasOne("OSKI_SOLUTIONS.DataAccess.Entities.Tests.Session.SessionOfTest", null)
                        .WithMany("Questions")
