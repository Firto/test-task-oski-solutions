...
namespace OSKI_SOLUTIONS.DataAccess.Migrations
{
    ...
    [Migration("20211111133923_add-end-date-time")]
    partial class addenddatetime
    {
            ...
            modelBuilder.Entity("OSKI_SOLUTIONS.DataAccess.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "admin",
                            Login = "admin",
                            PasswordHash = "F34D11NAFHWPR4T8253502A06030E66E1FA46DB28872FF60693BDA425AA785497C374EBD35FA4F5BFA2E09902EFCD8FF1F9C22365A"
                        });
                });
